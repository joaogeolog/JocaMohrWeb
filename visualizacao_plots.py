...
def plot_3d_block(params):
    """Visualização 3D completa com vetores Sn e Tau restaurados."""
    with st.container(border=True):
        ...
        # Restauração do Vetor Tau (Laranja)
        ...
        st.plotly_chart(fig, use_container_width=True, key="3d_plot_final")
