...
def plot_mohr(x_env, y_env, xt_coll, xc_s, yc_s, xc_f, yc_f, env_high, sn_p, tn_p, p_x, p_y, falhou, params):
    """Mohr usa o 'Ângulo com S1' para as contas de tensão."""
...
def plot_3d_block(params):
    """O bloco XYZ usa rigorosamente o 'Mergulho' para plotar o plano."""
    with st.container(border=True):
        ...
        # Orientação do Sn no espaço 3D (baseada no MERGULHO)
        if reg == 'Normal':
        ...
        # Plano ortogonal ao Sn (posicionado pelo Mergulho)
        sz = 45
        ...
        add_arrow(n_vec, "black", "Sn", s1, False) # Sn ortogonal ao plano
        
        # Magnitude do Tau baseada no Angulo com S1
