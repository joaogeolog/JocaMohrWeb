...
def plot_mohr(x_env, y_env, xt_coll, xc_s, yc_s, xc_f, yc_f, env_high, sn_p, tn_p, p_x, p_y, falhou, params):
    """Interface do Diagrama de Mohr com eixos técnicos e altura original."""
    with st.container(border=True):
        ...
        # Envoltórias (Tração, Cisalhamento e Colapso)
        for cond, col, name in [
            ...
            # Realce na envoltória em caso de falha
        ...
        # Círculo de Mohr: Sólido para estável, Tracejado para falha
...
def plot_3d_block(params):
    ...
    with st.container(border=True):
        # Título JocaMohr fixado no canto superior esquerdo
        st.markdown("""
