...
# 1. Configuração Base (Visual limpo, mas sem "espremer")
st.set_page_config(layout="wide", page_title="JocaMohr Web", page_icon="⚒️")

# Estilo sutil apenas para remover o cabeçalho padrão
...
# Geometria para o Plot de Mohr (Sólido/Tracejado)
